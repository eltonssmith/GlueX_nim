...
\begin{figure}[tbp]
\begin{center}
%\includegraphics[width=0.85\textwidth]{figures/FDC_wires_from_strips.pdf}  
\caption{\label{FDC_wires_from_strips} Wire (avalanche) positions reconstructed from the strips on the two cathodes in one FDC chamber.
}   
\end{center}  
\end{figure}
