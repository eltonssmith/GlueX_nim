...
Therefore, the cathodes on both sides of the wire plane have strips that in addition to the wires are readout allowing for a  reconstruction of a space point on the track from each chamber. 
...
In total $2,304$ wires and $10,368$ strips are read using charge pre-amplifiers with $10$~ns peaking time with a gain of $0.5$~mV/pC for the wires and $2.4$~mV/pC for the strips.
