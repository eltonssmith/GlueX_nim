...
\author[iu]{J.P.~Leckey\fnref{f6}}
\fntext[f6]{Current address: NASA}
\author[fsu]{D.I.~Lersch}
\author[uofr]{B.D.~Leverington\fnref{f7}}
\fntext[f7]{Current address: Leverington}
...
\author[jlab]{P.T.~Mattione\fnref{f8}}
\fntext[f8]{Current address: Deep Silver Volition, 1 E Main St., Champaign, IL 61820.}
...
\author[gwu]{W.~Phelps}
\author[jlab]{J.~Pierce\fnref{f9}}
\fntext[f9]{Current address: Oak Ridge National Laboratory, Oak Ridge, TN 37831.}
\author[uofr]{E.L.~Plummer\fnref{f10}}
\fntext[f10]{Current address: Plummer}
\author[jlab]{E.~Pooser}
\author[uconn]{B.~Pratt}
\author[jlab]{Y.~Qiang\fnref{f11}}
\fntext[f11]{Current address: Toshiba Medical Research Institute USA, Inc., 706 N Deerpath Dr, Vernon Hills, IL 60061.}
\author[nw]{N.~Qin}
\author[jlab]{V.~Razmyslovich\fnref{f12}}
\fntext[f12]{Current address: Razmyslovich}
...
\author[uofr]{L.A.~Teigrob\fnref{f14}}
\fntext[f14]{Current address: Teigrob}
\author[uofr]{A.~Teymurazyan}
\author[glasgow]{A.~Thiel}
\author[mephi]{I.~Tolstukhin\fnref{f15}}
\fntext[f15]{Current address: Argonne National Lab.}
\author[nw]{A.~Tomaradze}
\author[usm]{A.~Toro}
\author[fsu]{A.~Tsaris}
\author[cmu]{Y.~Van~Haarlem\fnref{f16}}
\fntext[f16]{Current address: Commonwealth Scientific and Industrial Research Organisation, Lucas Heights, NSW~2234, Australia.}
\author[uofa]{G.~Vasileiadis}
\author[usm]{I.~Vega}
\author[iu]{G.~Visser}
\author[uofa]{G.~Voulgaris}
\author[cua]{N.K.~Walford\fnref{f17}}
\fntext[f17]{Current address: AbbVie Deutschland GmbH, Knollstrasse 67061, Ludwigshafen, Germany.}
\author[glasgow]{D.~ Werthm\"uller\fnref{f18}}
\fntext[f18]{Current address: University of York, York YO10 5DD, United Kingdom.}
\author[jlab]{T.~Whitlatch}
\author[odu]{N.~Wickramaarachchi}
\author[mit]{M.~Williams}
\author[jlab]{E.~Wolin\fnref{f19}}
\fntext[f19]{Current address: 2808 Linden Ln, Williamsburg, VA 23185.}
\author[nw]{T.~Xiao}
\author[mit]{Y.~Yang}
