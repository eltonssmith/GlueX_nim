...
At a track momentum of 4~GeV/c, PID becomes much more difficult and represents the limit at which the a time-of-flight measurement can identify protons with high confidence. The separation between the large peak containing pions, kaons and positrons from the proton
...
\caption{\label{fig:betavsp}$\beta$ of positive charged tracks versus track momentum, showing bands for $e^+$, $\pi^+$, $K^+$ and $p$. The color coding of the third dimension
