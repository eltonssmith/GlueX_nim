...
The PMT output is connected to a splitter by a 55' long cables RG-58 coaxial cables {\color{red} Elton: assume cables are the same as for the BCAL; should check}. The signal is split by
