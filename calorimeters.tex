...
\includegraphics[width=0.45\textwidth]{figures/data_RMetaBCAL_EnSymmMean_sim_RMetaBCAL_EnSymmMean_sigma.png} \includegraphics[width=0.45\textwidth]{figures/data_RMetaBCAL_EnSymmMean_sim_RMetaBCAL_EnSymmMean_sigma.png} 
\caption{\label{fig:bcal:eta_resolution} 
a) The energy resolution of single photons in the BCAL calculated from the $\eta$ mass distribution under the assumption that only the energy resolution contributes to its width b) Placeholder for similar plot for FCAL.
(Color online)
 }
\end{figure}    
