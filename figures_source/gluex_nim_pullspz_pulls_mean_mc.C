...
//=========  (Thu Feb  6 10:34:48 2020) by ROOT version 6.18/04
   ...
   TH1F *Graph_Graph1040 = new TH1F("Graph_Graph1040","",100,0,0.99);
   ...
   Graph_Graph1040->GetXaxis()->SetTitle("Min Prob(#chi^{2},NDF)");
   ...
   cRes_Mean2->SetSelected(cRes_Mean2);
       ...
       cRes_Mean2->SaveAs("gluex_nim_pullspz_pulls_mean_mc.pdf");
