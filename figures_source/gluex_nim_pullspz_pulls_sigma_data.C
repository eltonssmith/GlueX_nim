...
//=========  (Thu Feb  6 10:34:37 2020) by ROOT version 6.18/04
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","",100,0,0.99);
   ...
   Graph_Graph1025->GetXaxis()->SetTitle("Min Prob(#chi^{2},NDF)");
   ...
   cRes_Sigma2->SaveAs("gluex_nim_pullspz_pulls_sigma_data.pdf");
