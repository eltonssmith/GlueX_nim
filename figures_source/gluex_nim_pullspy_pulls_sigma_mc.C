...
//=========  (Thu Feb  6 10:34:48 2020) by ROOT version 6.18/04
   ...
   TH1F *Graph_Graph1037 = new TH1F("Graph_Graph1037","",100,0,0.99);
   ...
   Graph_Graph1037->GetXaxis()->SetTitle("Min Prob(#chi^{2},NDF)");
   ...
   cRes_Sigma1->SaveAs("gluex_nim_pullspy_pulls_sigma_mc.pdf");
