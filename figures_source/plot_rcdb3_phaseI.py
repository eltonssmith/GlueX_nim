...
#run1_def = 40643  # fall 2017/spring 2018
#run1_def = 40771  # spring 2018
#run2_def = 42583
run2_def = 51768

# start of experiment
date_exp_start = datetime(2017,1,1)

# end of exp. (useful to estimate the fraction of time used)
date_exp_end = datetime(2018,11,26)
...
runs = db.select_runs("@is_production and @status_approved and event_count > 1000000 ",run1,run2) #and @status_approved
...
for i,run in enumerate(runs):
    ...
    if event_count_cnd and event_count_cnd.value > 100000:
        ...
        totdays = totdays + elapsedt.total_seconds()/3600./24.
        select_data['elapsed_time'].append(totdays)
...
#rad_type_AMO2 = '4.5x10-4 Al 40um'

rad_key = 'radiator_type'

sel_para_45_135 = ((select_data[rad_key] == 'JD70-100 58um 45/135 deg') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'JD70-104 17um 45/135 deg') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'JD70-104') & (select_data['polarization_angle'] == 135.0)) | ((select_data[rad_key] == 'JD70-105 47um 45/135 deg') & (select_data['polarization_direction'] == 'PARA'))
sel_perp_45_135 = ((select_data[rad_key] == 'JD70-100 58um 45/135 deg') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'JD70-104 17um 45/135 deg') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'JD70-104') & (select_data['polarization_angle'] == 45.0)) | ((select_data[rad_key] == 'JD70-105 47um 45/135 deg') & (select_data['polarization_direction'] == 'PERP'))
sel_para_0_90 = ((select_data[rad_key] == 'JD70-100 58um 0/90 deg') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'J1A50 50um') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'JD70-118 20um') & (select_data['polarization_direction'] == 'PARA'))  | ((select_data[rad_key] == 'JD70-119 20um') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'JD70-104 17um 0/90 deg') & (select_data['polarization_direction'] == 'PARA')) | ((select_data[rad_key] == 'JD70-104') & (select_data['polarization_angle'] == 0.0)) | ((select_data[rad_key] == 'JD70-105 47um 0/90 deg') & (select_data['polarization_direction'] == 'PARA'))
sel_perp_0_90 = ((select_data[rad_key] == 'JD70-100 58um 0/90 deg') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'J1A50 50um') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'JD70-118 20um') & (select_data['polarization_direction'] == 'PERP'))  | ((select_data[rad_key] == 'JD70-119 20um') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'JD70-104 17um 0/90 deg') & (select_data['polarization_direction'] == 'PERP')) | ((select_data[rad_key] == 'JD70-104') & (select_data['polarization_angle'] == 90.0)) | ((select_data[rad_key] == 'JD70-105 47um 0/90 deg') & (select_data['polarization_direction'] == 'PERP'))

sel_para = (select_data['polarization_direction'] == 'PARA')
sel_perp = (select_data['polarization_direction'] == 'PERP')

sel_AMO = (select_data[rad_key] == '3X10-4 Al 30um') | (select_data[rad_key] == '4.5x10-4 Al 40um') | (select_data[rad_key] == '3x10-4 RL')
#sel_AMO = (select_data[rad_key] == '4.5x10-4 Al 40um')
...
time_days_all = select_data['elapsed_time'] 
time_days_perp_45_135 =  select_data['elapsed_time'][sel_perp_45_135] 
time_days_para_45_135 =  select_data['elapsed_time'][sel_para_45_135] 
time_days_perp_0_90 =  select_data['elapsed_time'][sel_perp_0_90] 
time_days_para_0_90 =  select_data['elapsed_time'][sel_para_0_90] 
time_days_AMO =  select_data['elapsed_time'][sel_AMO] 
...
strparafrac = '%.0f' % (100.*total_para_0_90/total_all + 0.5)
strperpfrac = '%.0f' % (100.*total_perp_0_90/total_all +0.5)
str135frac = '%.0f' % (100.*total_perp_45_135/total_all +0.5)
str45frac = '%.0f' % (100.*total_para_45_135/total_all +0.5)
stramofrac = '%.0f' % (100.*total_AMO/total_all +0.5)
...
plt.tick_params(axis='x', labelsize=20,direction='in', length=6, width=2)
plt.tick_params(axis='y', labelsize=20,direction='in', length=6, width=2)
...
#plt.title("Date printed: "+str(date.today()))
plt.ylabel("Int Trig Count")
plt.xlabel("Calender Running Time (days)")
ymin, ymax = plt.ylim()
plt.legend(bbox_to_anchor=(0.56,0.99))
...
figs[0].savefig("fig1.eps");
figs[1].savefig("fig2.eps");
figs[2].savefig("fig3.eps");
figs[3].savefig("fig4.eps");
