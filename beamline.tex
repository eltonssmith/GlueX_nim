...
The fraction of tagged photons reaching the \gx{} target is determined as a function
of energy from individual TAC coincidence measurements with each tagging
counter. These ``tagging fraction'' are used to scale the counts measured in
the PS in order to obtain the total tagged flux that reached the \gx{} target
during a given run period.
