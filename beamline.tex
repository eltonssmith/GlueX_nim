...
In a TAC run, the number of beam photons passing through the collimator is determined at the Pair Spectrometer ({\color{red}refer to figure of PS yield spectrum}), this is then compared to the number of photons reaching the TAC and used to measure the acceptance of the PS.  This allows the acceptance-corrected PS spectrum at physics beam currents to be used to determine the absolute flux.
