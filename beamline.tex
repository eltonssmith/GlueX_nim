\section[The coherent photon source and beam line]{The coherent photon source and beam line \label{sec:beamline}}
...
The electron beam position at the radiator is monitored and controlled using beam position monitors, named 5C11 and 5C11B; the position of the latter is indicated in Figure \ref{fig:beam:Draw_beamline}, which are located at the end of the accelerator tunnel just upstream of the Tagger Hall.
