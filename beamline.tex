...
In addition to the diamond radiators, several aluminium radiators of thicknesses ranging from 1.5 to 40~$\mu$m are used to normalize the rate spectra measured in the Pair Spectrometer, correcting for its acceptance.
