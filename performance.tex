...
We illustrate the distributions of the kinematic fit $\chi^2$ and probability in Fig.~\ref{fig:kinfitperform} for both reconstructed and simulated data.  The agreement between the two is obscured by the larger background in reconstructed data, as illustrated by the extensive tails of the distribution to large $\chi^2$.  
...
As an example, the pull distributions for the momentum components of the $\pi^-$ in reconstructed $\gamma p \to \eta p$, $\eta \to \pi^+\pi^-\pi^0$ events are shown in Fig.~\ref{fig:kinfitpullex}



\begin{figure}[tbp]
\begin{center}
\includegraphics[width=0.85\textwidth]{figures/Compare_probDist_etaCut.pdf}
...
\begin{figure}[tbp]
\begin{center}          \includegraphics[width=0.75\textwidth]{figures/pxPull_data17_etaCut.pdf}\\
\includegraphics[width=0.75\textwidth]{figures/pxPull_geant4_etaCut.pdf}
