...
(Left top) $\pi^+\pi^-\pi^0$ invariant mass distribution from $\gamma p \to \pi^+\pi^-\pi^0 p$ events, illustrating the strong peak due to $\omega$ meson production.  Other structures can be seen, for example peaks corresponding to the production of $\eta$ and $\phi$ mesons.  The $\omega$ peak resolution is 26.1~MeV using just the reconstructed  particle 4-vectors, and is 16.4 after a kinematic fit.
(Right top) $\pi^+\pi^-$ invariant mass distribution from $\gamma p \to K_S K^+ \pi^- p$, $K_S\to\pi^+\pi^-$ events, illustrating the peak due to $K_S\to\pi^+\pi^-$ decays.  The $K_S$ peak resolution is 17.0~MeV using just the reconstructed charged particle 4-vectors, and is 8.6~MeV after a kinematic fit imposing energy and momentum conservation
