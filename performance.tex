...
%We first note that the improvement in the invariant mass resolution was seen to be $\approx20\%?$ for common reactions studied at GlueX. 
...
%\includegraphics[width=0.47\textwidth]{figures/eta_KFit_Prob.pdf}
%\includegraphics[width=0.47\textwidth]{figures/eta_KFit_Prob.pdf}
          \includegraphics[width=0.65\textwidth]{pxPull_data17_etaCut.pdf}\\
          \includegraphics[width=0.65\textwidth]{pxPull_geant4_etaCut.pdf}
\caption{\label{fig:kinfitperform}
(Left) ...
 (Color online)}
\end{center}
